...
from benchmarking.circuit_optimization import CircuitSimulationFunction 
from benchmarking.circuit_bandgap import Circuit_bandgap
from benchmarking.circuit_OTA_three import Circuit_OTA_three
from benchmarking.circuit_40_OTA_two import Circuit_40_OTA_two
from benchmarking.circuit_40_OTA_three import Circuit_40_OTA_three
...
def get_test_function(name: str, noise_std: float, seed: int = 0,bounds=None):
    ...
    TEST_FUNCTIONS = {
        ...
        'OTA_two': (CircuitSimulationFunction, dict(bounds=bounds, noise_std=noise_std, negate=False)),
        '40_OTA_two': (Circuit_40_OTA_two, dict(bounds=bounds, noise_std=noise_std, negate=False)),
        '40_OTA_three': (Circuit_40_OTA_three, dict(bounds=bounds, noise_std=noise_std, negate=False)),
        'OTA_three': (Circuit_OTA_three, dict(bounds=bounds, noise_std=noise_std, negate=False)),
        'bandgap': (Circuit_bandgap, dict(bounds=bounds, noise_std=noise_std, negate=False)),
   }
