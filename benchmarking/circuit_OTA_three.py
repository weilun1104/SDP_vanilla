...
class Circuit_OTA_three(SyntheticTestFunction):
    def __init__(
        self,
        bounds: list,
        noise_std: float = 0,
    ...
    def evaluate_true(self, X: Tensor) -> Tensor:
        ...
        scaling_factors = torch.tensor([1e-13,1e-13,1e-8,1e-8,1e-8,1e-8,1e-8,1e-8,1e-8,1e-8,1e-7,1e-8,1e-6,1e-6,1e-7,1e-7,1e-6,1e-6]).to('cuda:0')
